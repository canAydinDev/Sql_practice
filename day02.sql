...
--parentta olmayan primary key ile child a veri girisi yapilamaz

--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
insert into child  values(null,4000,'Bisiklet','Nuri');

--soru 4: parent tabloda vergino 101 olan veriyi siliniz
...
drop table parent; --child silinmeden parent silinemez
...
--on delete cascade kullanarak child i silmeden parenttakini sildik tabi child da silindi
select * from parent2;
delete from parent2;
